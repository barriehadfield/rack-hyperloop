...
# gem 'hyper-store', github: 'janbiedermann/hyper-store', branch: 'pinta'
# gem 'hyper-react', github: 'janbiedermann/hyper-react', branch: 'pinta'
# gem 'hyper-router', github: 'janbiedermann/hyper-router', branch: 'pinta'
